<#
.SYNOPSIS
    Steam Manifest Downloader - Downloads depot manifests for SteamVault

.DESCRIPTION
    Downloads depot manifests when SteamVault servers are unavailable.
...
$Host.UI.RawUI.WindowTitle = "Steam Manifest Downloader (For SteamVault)"
...
function Write-Header {
    ...
    Write-Host "  |        STEAM MANIFEST DOWNLOADER (For SteamVault)              |" -ForegroundColor Cyan
...
if ($env:MANIFEST_MODE) {
    ...
    Write-Host ""
    Write-Host "    1. Github Mirror" -ForegroundColor White
    Write-Host "    2. Morrenus" -ForegroundColor White
    Write-Host "    3. ManifestHub" -ForegroundColor White
    Write-Host ""
    do {
